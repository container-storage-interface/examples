...
var (
	loadGoPluginsOnce    sync.Once
	serviceProviderCtors = map[string]func() interface{}{}
)

// LoadGoPlugins reads the value of the environment variable
// CSI_PLUGINS, a CSV with each element being the absolute path to
